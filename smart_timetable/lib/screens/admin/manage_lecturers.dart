...
class _ManageLecturersState extends State<ManageLecturers> {
  ...
  bool _validate() {
    if (_nameController.text.trim().isEmpty) {
      setState(() => _errorMessage = 'Lecturer name cannot be empty.');
      return false;
    }
    ...
    if (_selectedCourseId == null) {
      setState(() => _errorMessage = 'Please assign a course.');
      return false;
    }
    return true;
  }
  ...
  Future<void> _saveLecturer() async {
    ...
    try {
      ...
      if (_editingId != null) {
        await _db.collection('lecturers').doc(_editingId).update(data);
      } else {
      ...
      setState(() => _errorMessage = 'Failed to save lecturer. Try again.');
    }
  }
  ...
  Future<void> _deleteLecturer(String id) async {
    try {
      ...
      setState(() => _errorMessage = 'Failed to delete lecturer. Try again.');
    }
  }
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                _editingId != null ? 'Edit Lecturer' : 'Add New Lecturer',
              ...
              const SizedBox(height: 16),
              // Course dropdown from Firestore
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final validIds = _coursesDocs.map((d) => d.id).toList();
                  if (_selectedCourseId != null &&
              ...
              ElevatedButton(
                ...
                child: Text(
                  _editingId != null ? 'Update Lecturer' : 'Add Lecturer',
                ),
              ),
              if (_editingId != null) ...[
                const SizedBox(height: 8),
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                return const Center(child: Text('No lecturers added yet.'));
              }
